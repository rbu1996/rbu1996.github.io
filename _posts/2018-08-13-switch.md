...
```
#### Create and Connect to port-channel96
```
interface port-channel96        //进入上连端口
  description "Port-Channel 96 is for R5-3232C, with interface E1/31 E1/32"
  switchport mode trunk         //将端口配置为Trunk模式
```
#### Connect to port-channel and associate with FEX 101
```
interface port-channel96        //进入上连端口
  description "Port-Channel 96 is for R5-3232C, with interface E1/31 E1/32"
 E1/47-48 E2/13-16"
...
interface Ethernet1/1       
  description "Connect to R2-2248, belongs to Port-Channel 96"
  switchport mode fex-fabric        //设置端口属性为FEX连接属性 
  fex associate 101       //设定连接的fex号码，在连接成功后，以E 101/1/X表示扩展端口
  channel-group 101         //加入port-channel 1
```
#### Interfave Ethernet and access VLAN
```
interface Ethernet1/1
  switchport access vlan 30
